...
contract CreateRouterTest is Test, BaseSeaportTest, BaseLiquidDelegateTest, SeaportHelpers {
    ...
    function setUp() public {
        createRouter = new CreateRouter(address(seaport), address(conduit), address(dt));
        ...
        returns (AdvancedOrder memory depositorOrder, AdvancedOrder memory routerOrder)
    {
        ...
        depositorOrder =
            AdvancedOrder({parameters: depositorOrderParams, numerator: 1, denominator: 1, signature: _signOrder(signer, depositorOrderParams), extraData: ""});
        // CreateRouter order
        ...
        returns (AdvancedOrder memory delegateTokenOrder)
    {
        ...
        delegateTokenOrder =
            AdvancedOrder({parameters: delegateTokenOrderParams, numerator: 1, denominator: 1, signature: _signOrder(signer, delegateTokenOrderParams), extraData: ""});
    }
